...
const images = [
  {
    img: Img1,
    alt: "Uma sala de aula cheia de alunos sentados em suas carteiras. Um professor, a frente da sala, está dando uma aula de matemática. Ele usa óculos, está com uma camisa verde escura e olhando para a lousa. A lousa está com 4 cálculos matemáticos e é iluminada por algumas luminárias próprias, presas no teto.",
  },
  {
    img: Img2,
    alt: "Um conjunto de seis pessoas reunidas. Uma mulher loira, com um suéter vinho, sorrindo e usando óculos, está sentada em uma cadeira onde, a sua frente, há uma mesa com um notebook. Uma mulher morena de cabelos longos, utilizando uma blusa azul com detalhes em branco e verde, está sorrindo e apontando para o notebook. Um homem moreno, com barba e bigode, vestindo uma camisa social azul escuro, está sentado ao lado da mulher sentada, também aponta para o notebook e sorri. Há uma mulher negra, atrás da mulher sentada com o notebook, de pé. Ela tem tranças no cabelo e está com uma camiseta cinza claro. Ao lado dela, há outra mulher, morena, utilizando uma camisa social branca. Ela está de pé e sorrindo. Ao seu lado, um homem de barba grisalha e óculos, está sorrindo e comemorando, além de utilizar uma camisa sozial cinza.",
  },
  {
    img: Img3,
      ...
      <S.Images id="carousel-items" aria-live="off">
        {images.map((image, i) => (
          <S.Image key={i} role="group" aria-roledescription="slide" active={i === index} aria-label={`Image ${i + 1} of ${images.length}`}>
            <img src={image.img} alt={image.alt} loading="lazy" draggable="false" width={2000} height={800} />
          </S.Image>
        ))}
      </S.Images>
      <S.Dots>
